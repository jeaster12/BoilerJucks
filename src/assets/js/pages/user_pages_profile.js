...
$(function() {
    ...
    require(
        ...
        function (ec, Cupcake) {
            ...
            // Init
            var sales = ec.init(document.getElementById('sales'), Cupcake);
            var visits = ec.init(document.getElementById('visits'), Cupcake);
            var plans = ec.init(document.getElementById('plans'), Cupcake);
