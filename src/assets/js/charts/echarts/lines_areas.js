...
$(function() {
    ...
    require(
        ...
        function (ec, Cupcake) {
            ...
            var basic_lines = ec.init(document.getElementById('basic_lines'), Cupcake);
            var stacked_lines = ec.init(document.getElementById('stacked_lines'), Cupcake);
            var inverted_axes = ec.init(document.getElementById('inverted_axes'), Cupcake);
            var line_point = ec.init(document.getElementById('line_point'), Cupcake);
            var basic_area = ec.init(document.getElementById('basic_area'), Cupcake);
            var stacked_area = ec.init(document.getElementById('stacked_area'), Cupcake);
            var reversed_value = ec.init(document.getElementById('reversed_value'), Cupcake);
