...
$(function () {
    ...
    require(
        ...
        function (ec, Cupcake) {
            ...
            var basic_columns = ec.init(document.getElementById('basic_columns'), Cupcake);
            var stacked_columns = ec.init(document.getElementById('stacked_columns'), Cupcake);
            var stacked_clustered_columns = ec.init(document.getElementById('stacked_clustered_columns'), Cupcake);
            var thermometer_columns = ec.init(document.getElementById('thermometer_columns'), Cupcake);
            var compositive_waterfall = ec.init(document.getElementById('compositive_waterfall'), Cupcake);
            var change_waterfall = ec.init(document.getElementById('change_waterfall'), Cupcake);
            var columns_timeline = ec.init(document.getElementById('columns_timeline'), Cupcake);
