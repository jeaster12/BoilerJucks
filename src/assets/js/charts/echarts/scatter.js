...
$(function () {
    ...
    require(
        ...
        function (ec, Cupcake) {
            ...
            var basic_scatter = ec.init(document.getElementById('basic_scatter'), Cupcake);
            var bubble_size = ec.init(document.getElementById('bubble_size'), Cupcake);
            var large_scale = ec.init(document.getElementById('large_scale'), Cupcake);
            var scale_roaming = ec.init(document.getElementById('scale_roaming'), Cupcake);
            var category_scatter = ec.init(document.getElementById('category_scatter'), Cupcake);
            var time_data = ec.init(document.getElementById('time_data'), Cupcake);
            var timeline_scatter = ec.init(document.getElementById('timeline_scatter'), Cupcake);
