...
<h6 class="content-group text-semibold">
	Button layouts
	<small class="display-block">Basic buttons and layout options</small>
</h6>
<!-- /button layouts title -->
...
<div class="row">
	<div class="col-md-4">
		<div class="panel panel-body border-top-primary text-center">
			<h6 class="no-margin text-semibold">Default buttons</h6>
...
<div class="row">
	...
	<div class="col-md-4">
		<div class="panel panel-body border-top-primary text-center">
			...
			<div class="btn-group">
				<button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">Dropdown
					<span class="caret"></span>
				</button>
				<ul class="dropdown-menu dropdown-menu-right">
					<li><a href="#"><i class="icon-menu7"></i> Action</a></li>
...
<div class="row">
	...
	<div class="col-md-4">
		<div class="panel panel-body border-top-primary text-center">
			<h6 class="no-margin text-semibold">Rounded with menus</h6>
			<p class="text-muted content-group-sm">Rounded button with dropdown</p>

			<div class="btn-group">
				<button type="button" class="btn btn-danger btn-rounded dropdown-toggle" data-toggle="dropdown">Dropdown
					<span class="caret"></span>
				</button>
				<ul class="dropdown-menu dropdown-menu-right">
					<li><a href="#"><i class="icon-menu7"></i> Action</a></li>
...
<div class="row">
	...
	<div class="col-md-4">
		<div class="panel panel-body border-top-primary text-center">
			...
			<div class="btn-group">
				<button type="button" class="btn bg-teal-400 btn-labeled dropdown-toggle" data-toggle="dropdown"><b><i class="icon-reading"></i></b> Dropdown
					<span class="caret"></span>
				</button>
				<ul class="dropdown-menu dropdown-menu-right">
					<li><a href="#"><i class="icon-menu7"></i> Action</a></li>
...
<div class="row">
	...
	<div class="col-md-4">
		<div class="panel panel-body border-top-primary text-center">
			...
			<div class="btn-group">
				<button type="button" class="btn border-slate text-slate-800 btn-flat dropdown-toggle" data-toggle="dropdown">Dropdown
					<span class="caret"></span>
				</button>
				<ul class="dropdown-menu dropdown-menu-right">
					<li><a href="#"><i class="icon-menu7"></i> Action</a></li>
...
<div class="row">
	...
	<div class="col-md-4">
		<div class="panel panel-body border-top-primary text-center">
			...
			<div class="btn-group">
				<button type="button" class="btn btn-link dropdown-toggle" data-toggle="dropdown">Dropdown
					<span class="caret"></span>
				</button>
				<ul class="dropdown-menu dropdown-menu-right">
					<li><a href="#"><i class="icon-menu7"></i> Action</a></li>
...
<div class="row">
	...
	<div class="col-md-4">
		<div class="panel panel-body border-top-primary text-center">
			...
			<p class="text-muted content-group-sm">Works with
				<code>all</code> button types</p>
...
<div class="row">
	...
	<div class="col-md-4">
		<div class="panel panel-body border-top-primary text-center">
			...
			<button type="button" class="btn btn-info btn-float"><i class="icon-search4"></i>
				<span>Search</span>
			</button>
			<button type="button" class="btn btn-danger btn-float btn-float-lg"><i class="icon-html52"></i>
				<span>Download</span>
			</button>
			<button type="button" class="btn btn-info btn-float btn-loading" data-loading-text="<i class='icon-spinner4 spinner'></i> <span>Update</span>"><i class="icon-spinner4"></i>
				<span>Update</span>
			</button>
		</div>
	</div>
...
<div class="row">
	<div class="col-md-4">
		<div class="panel panel-body border-top-primary text-center">
			...
			<p>
				<button type="button" class="btn btn-primary btn-xlg"><i class="icon-comment-discussion position-left"></i> Extra large size</button>
			</p>
			<p>
				<button type="button" class="btn btn-danger btn-lg"><i class="icon-comment-discussion position-left"></i> Large size</button>
			</p>
			<p>
				<button type="button" class="btn btn-success"><i class="icon-comment-discussion position-left"></i> Default size</button>
			</p>
			<p>
				<button type="button" class="btn btn-warning btn-sm"><i class="icon-comment-discussion position-left"></i> Small size</button>
			</p>
			<p>
				<button type="button" class="btn btn-info btn-xs"><i class="icon-comment-discussion position-left"></i> Mini size</button>
			</p>
		</div>
	</div>
	...
	<div class="col-md-4">
		<div class="panel panel-body border-top-primary text-center">
			...
			<p class="text-muted content-group-sm">Available styling of
				<code>labeled</code> button</p>

			<p>
				<button type="button" class="btn btn-primary btn-labeled btn-xlg"><b><i class="icon-pin-alt"></i></b> Extra large size</button>
			</p>
			<p>
				<button type="button" class="btn btn-danger btn-labeled btn-lg"><b><i class="icon-pin-alt"></i></b> Large size</button>
			</p>
			<p>
				<button type="button" class="btn btn-success btn-labeled"><b><i class="icon-pin-alt"></i></b> Default size</button>
			</p>
			<p>
				<button type="button" class="btn btn-warning btn-labeled btn-sm"><b><i class="icon-pin-alt"></i></b> Small size</button>
			</p>
			<p>
				<button type="button" class="btn btn-info btn-labeled btn-xs"><b><i class="icon-pin-alt"></i></b> Mini size</button>
			</p>
		</div>
	</div>
	...
	<div class="col-md-4">
		<div class="panel panel-body border-top-primary text-center">
			...
			<p class="text-muted content-group-sm">Available styling of
				<code>rounded</code> button</p>

			<p>
				<button type="button" class="btn btn-primary btn-rounded btn-xlg"><i class="icon-mention position-left"></i> Extra large size</button>
			</p>
			<p>
				<button type="button" class="btn btn-danger btn-rounded btn-lg"><i class="icon-mention position-left"></i> Large size</button>
			</p>
			<p>
				<button type="button" class="btn btn-success btn-rounded"><i class="icon-mention position-left"></i> Default size</button>
			</p>
			<p>
				<button type="button" class="btn btn-warning btn-rounded btn-sm"><i class="icon-mention position-left"></i> Small size</button>
			</p>
			<p>
				<button type="button" class="btn btn-info btn-rounded btn-xs"><i class="icon-mention position-left"></i> Mini size</button>
			</p>
		</div>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-md-4">
		<div class="panel panel-body border-top-primary text-center">
			...
			<div class="btn-group">
				<button type="button" class="btn bg-brown dropdown-toggle" data-toggle="dropdown">Dropdown <i class="icon-menu7 position-right"></i>
					<span class="caret"></span>
				</button>
				<ul class="dropdown-menu dropdown-menu-right">
					<li><a href="#"><i class="icon-menu7"></i> Action</a></li>
...
<div class="row">
	...
	<div class="col-md-4">
		<div class="panel panel-body border-top-primary text-center">
			...
			<div class="btn-group">
				<button type="button" class="btn btn-danger btn-labeled btn-labeled-right dropdown-toggle" data-toggle="dropdown"><b><i class="icon-menu7"></i></b> Dropdown
					<span class="caret"></span>
				</button>
				<ul class="dropdown-menu dropdown-menu-right">
					<li><a href="#"><i class="icon-menu7"></i> Action</a></li>
...
<div class="row">
	<div class="col-md-4">
		<div class="panel panel-body border-top-primary text-center">
			...
			<div class="btn-group btn-group-fade">
				<button type="button" class="btn btn-success dropdown-toggle" data-toggle="dropdown">Button dropdown
					<span class="caret"></span>
				</button>
	...
	<div class="col-md-4">
		<div class="panel panel-body border-top-primary text-center">
			...
			<p class="text-muted content-group-sm">Animate menu with
...
<div class="row">
	<div class="col-md-4">
		<div class="panel panel-body border-top-primary text-center">
			...
			<div class="btn-group dropup">
				<button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">Dropup
					<span class="caret"></span>
				</button>
				<ul class="dropdown-menu dropdown-menu-right">
					<li><a href="#"><i class="icon-menu7"></i> Action</a></li>
	...
	<div class="col-md-4">
		<div class="panel panel-body border-top-primary text-center">
			...
			<div class="btn-group">
				<button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown"><i class="icon-cog5 position-left"></i> Dropdown
					<span class="caret"></span>
				</button>
				<ul class="dropdown-menu dropdown-menu-right">
					<li><a href="#"><i class="icon-menu7"></i> Action</a></li>
...
<div class="row">
	<div class="col-md-4">
		<div class="panel panel-body border-top-primary text-center">
			...
			<p class="text-muted content-group-sm">Dropup attached to
				<code>rounded</code> button</p>
	...
	<div class="col-md-4">
		<div class="panel panel-body border-top-primary text-center">
			...
			<div class="btn-group">
				<button type="button" class="btn btn-danger btn-rounded dropdown-toggle" data-toggle="dropdown"><i class="icon-cog5 position-left"></i> Dropdown
					<span class="caret"></span>
				</button>
				<ul class="dropdown-menu dropdown-menu-right">
					<li><a href="#"><i class="icon-menu7"></i> Action</a></li>
...
<div class="row">
	<div class="col-md-4">
		<div class="panel panel-body border-top-primary text-center">
			...
			<div class="btn-group dropup">
				<button type="button" class="btn bg-teal-400 btn-labeled dropdown-toggle" data-toggle="dropdown"><b><i class="icon-law"></i></b> Dropup
					<span class="caret"></span>
				</button>
				<ul class="dropdown-menu dropdown-menu-right">
					<li><a href="#"><i class="icon-menu7"></i> Action</a></li>
	...
	<div class="col-md-4">
		<div class="panel panel-body border-top-primary text-center">
			...
			<div class="btn-group">
				...
				<button type="button" class="btn bg-slate dropdown-toggle" data-toggle="dropdown">
					<span class="caret"></span>
				</button>
				<ul class="dropdown-menu dropdown-menu-right">
					<li><a href="#"><i class="icon-menu7"></i> Action</a></li>
...
<div class="row">
	<div class="col-md-4">
		...
		<div class="panel panel-body border-top-primary text-center">
			...
			<p class="text-muted content-group-sm">Bootstrap
				<code>radio</code> button group</p>
		...
		<div class="panel panel-body border-top-primary text-center">
			...
			<p class="text-muted content-group-sm">Justified
				<code>links</code> in button group</p>
	...
	<div class="col-md-4">
		<div class="panel panel-body border-top-primary text-center">
			...
			<p class="text-muted content-group-sm">Group of buttons in
				<code>btn-group</code>
			</p>
		...
		<div class="panel panel-body border-top-primary text-center">
			...
			<p class="text-muted content-group-sm">Using
		...
		<div class="panel panel-body border-top-primary text-center">
			...
			<div class="btn-group">
				...
				<div class="btn-group">
					<button type="button" class="btn bg-teal-400 dropdown-toggle" data-toggle="dropdown">Dropdown
						<span class="caret"></span>
					</button>
					<ul class="dropdown-menu dropdown-menu-right">
						<li><a href="#"><i class="icon-menu7"></i> Action</a></li>
	...
	<div class="col-md-4">
		<div class="panel panel-body border-top-primary text-center">
			...
			<p class="text-muted content-group-sm">Complex
				<code>btn-group</code> components</p>
		...
		<div class="panel panel-body border-top-primary text-center">
			...
			<p class="text-muted content-group-sm">Bootstrap
				<code>checkbox</code> button group</p>
		...
		<div class="panel panel-body border-top-primary text-center">
			...
			<p class="text-muted content-group-sm">Justified
				<code>buttons</code> in button group</p>
...
<div class="row">
	<div class="col-md-4">
		<div class="panel panel-body border-top-primary text-center">
			...
			<button type="button" class="btn btn-default btn-ladda btn-ladda-spinner" data-style="expand-left" data-spinner-color="#333" data-spinner-size="20">
		...
		<div class="panel panel-body border-top-primary text-center">
			...
			<button type="button" class="btn btn-default btn-ladda btn-ladda-spinner" data-style="expand-right" data-spinner-color="#333" data-spinner-size="20">
				<span class="ladda-label">Spinner</span>
			</button>
		...
		<div class="panel panel-body border-top-primary text-center">
			...
			<button type="button" class="btn btn-default btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="expand-up">
				<span class="ladda-label">Spinner</span>
			</button>
		...
		<div class="panel panel-body border-top-primary text-center">
			...
			<button type="button" class="btn btn-default btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="expand-down">
				<span class="ladda-label">Spinner</span>
			</button>
	...
	<div class="col-md-4">
		<div class="panel panel-body border-top-primary text-center">
			...
			<button type="button" class="btn btn-default btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="slide-left">
				<span class="ladda-label">Spinner</span>
			</button>
		...
		<div class="panel panel-body border-top-primary text-center">
			...
			<button type="button" class="btn btn-default btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="slide-right">
				<span class="ladda-label">Spinner</span>
			</button>
		...
		<div class="panel panel-body border-top-primary text-center">
			...
			<button type="button" class="btn btn-default btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="slide-up">
				<span class="ladda-label">Spinner</span>
			</button>
			<button type="button" class="btn bg-slate-400 btn-ladda btn-ladda-progress" data-style="slide-up">
				<span class="ladda-label">Spinner + Progress</span>
			</button>
		</div>
		...
		<div class="panel panel-body border-top-primary text-center">
			...
			<button type="button" class="btn btn-default btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="slide-down">
				<span class="ladda-label">Spinner</span>
			</button>
			<button type="button" class="btn bg-slate-400 btn-ladda btn-ladda-progress" data-style="slide-down">
				<span class="ladda-label">Spinner + Progress</span>
			</button>
		</div>
	</div>
	...
	<div class="col-md-4">
		<div class="panel panel-body border-top-primary text-center">
			...
			<button type="button" class="btn btn-default btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in">
				<span class="ladda-label">Spinner</span>
			</button>
		...
		<div class="panel panel-body border-top-primary text-center">
			...
			<button type="button" class="btn btn-default btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-out">
				<span class="ladda-label">Spinner</span>
			</button>
		...
		<div class="panel panel-body border-top-primary text-center">
			...
			<button type="button" class="btn btn-default btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="fade">
				<span class="ladda-label">Spinner</span>
			</button>
		...
		<div class="panel panel-body border-top-primary text-center">
			...
			<button type="button" class="btn btn-default btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="radius">
				<span class="ladda-label">Spinner</span>
			</button>
...
<!-- <div class="footer text-muted">
	&copy; 2015. <a href="#">Cupcake Web App Kit</a>
</div> -->
<!-- /footer -->
