...
$(function () {
    ...
    require(
        ...
        function (ec, Cupcake) {
            ...
            var basic_pie = ec.init(document.getElementById('basic_pie'), Cupcake);
            var basic_donut = ec.init(document.getElementById('basic_donut'), Cupcake);
            var nested_pie = ec.init(document.getElementById('nested_pie'), Cupcake);
            var infographic_donut = ec.init(document.getElementById('infographic_donut'), Cupcake);
            var rose_diagram_hidden = ec.init(document.getElementById('rose_diagram_hidden'), Cupcake);
            var rose_diagram_visible = ec.init(document.getElementById('rose_diagram_visible'), Cupcake);
            var lasagna_donut = ec.init(document.getElementById('lasagna_donut'), Cupcake);
            var pie_timeline = ec.init(document.getElementById('pie_timeline'), Cupcake);
            var multiple_donuts = ec.init(document.getElementById('multiple_donuts'), Cupcake);
