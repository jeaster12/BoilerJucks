...
$(function () {
    ...
    require(
        ...
        function (ec, Cupcake) {
            ...
            var basic_bars = ec.init(document.getElementById('basic_bars'), Cupcake);
            var stacked_bars = ec.init(document.getElementById('stacked_bars'), Cupcake);
            var stacked_clustered_bars = ec.init(document.getElementById('stacked_clustered_bars'), Cupcake);
            var floating_bars = ec.init(document.getElementById('floating_bars'), Cupcake);
            var irregular_bars = ec.init(document.getElementById('irregular_bars'), Cupcake);
            var tornado_bars_negative = ec.init(document.getElementById('tornado_bars_negative'), Cupcake);
            var tornado_bars_staggered = ec.init(document.getElementById('tornado_bars_staggered'), Cupcake);
