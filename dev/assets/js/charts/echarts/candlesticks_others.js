...
$(function () {
    ...
    require(
        ...
        function (ec, Cupcake) {
            ...
            var candlestick_basic = ec.init(document.getElementById('candlestick_basic'), Cupcake);
            var candlestick_line = ec.init(document.getElementById('candlestick_line'), Cupcake);
            var candlestick_scatter = ec.init(document.getElementById('candlestick_scatter'), Cupcake);

            var radar_basic = ec.init(document.getElementById('radar_basic'), Cupcake);
            var radar_filled = ec.init(document.getElementById('radar_filled'), Cupcake);

            var gauge_basic = ec.init(document.getElementById('gauge_basic'), Cupcake);
            var gauge_styling = ec.init(document.getElementById('gauge_styling'), Cupcake);
