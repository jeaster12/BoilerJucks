...
$(function () {
    ...
    require(
        ...
        function (ec, Cupcake) {
            ...
            var funnel_asc = ec.init(document.getElementById('funnel_asc'), Cupcake);
            var funnel_desc = ec.init(document.getElementById('funnel_desc'), Cupcake);
            var funnel_left = ec.init(document.getElementById('funnel_left'), Cupcake);
            var funnel_right = ec.init(document.getElementById('funnel_right'), Cupcake);
            var funnel_multiple_overlay = ec.init(document.getElementById('funnel_multiple_overlay'), Cupcake);
            var funnel_multiple_separate = ec.init(document.getElementById('funnel_multiple_separate'), Cupcake);

            var chord_basic = ec.init(document.getElementById('chord_basic'), Cupcake);
            var chord_sorting = ec.init(document.getElementById('chord_sorting'), Cupcake);
            var chord_non_ribbon = ec.init(document.getElementById('chord_non_ribbon'), Cupcake);
            var chord_scale = ec.init(document.getElementById('chord_scale'), Cupcake);
