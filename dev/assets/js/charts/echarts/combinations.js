...
$(function () {
    ...
    require(
        ...
        function (ec, Cupcake) {
            ...
            var line_bar = ec.init(document.getElementById('line_bar'), Cupcake);
            var column_pie = ec.init(document.getElementById('column_pie'), Cupcake);
            var scatter_pie = ec.init(document.getElementById('scatter_pie'), Cupcake);
            var scatter_line = ec.init(document.getElementById('scatter_line'), Cupcake);

            var connect_pie = ec.init(document.getElementById('connect_pie'), Cupcake);
            var connect_column = ec.init(document.getElementById('connect_column'), Cupcake);

            var candlestick_scatter = ec.init(document.getElementById('candlestick_scatter'), Cupcake);
