...
;(function( $, window, document, undefined ){
    ...
    // Plugin constructor
    var cupcakeWidget = function( elem, options ){
            this.elem = elem;
            this.$elem = $(elem);
    ...
    // Plugin prototype
    cupcakeWidget.prototype = {

        defaults: {

            // General
            autoSelector:           '.cupcake-widget',
            type :                  undefined,
            target:                 undefined,
            find:                   undefined,
            parent:                 true,
        ...
        init: function() {
            ...
            // Log
            widget.log = $.fn.cupcakewidget.log;
            ...
            $.each(widget.config, function(key, val){
                if(typeof val === "function"){
                    widget.$elem.on(key + ".cupcake", function() {
                        val(widget.$elem);
                    });
                }
            });
        ...
        _fullscreen : function(){
            ...
            var expandMarkup = $.fn.cupcakewidget.expandMarkup(config),
                contractMarkup = $.fn.cupcakewidget.contractMarkup(config);
            ...
            elem.on('click', function (e){
                ...
                elem.trigger("beforeInit.cupcake");
                ...
                elem.trigger("afterInit.cupcake");
        ...
        _delete : function() {
            ...
            var deleteMarkup = $.fn.cupcakewidget.deleteMarkup(config);
                        ...
                        element.velocity(
                            anim,
                            {
                                ...
                                begin: function (elements) {
                                    elem.trigger("begin.cupcake");
                                },
                                complete: function (elements) {
                                    elem.trigger("complete.cupcake");
                                    element.remove();
                                }
                            }
                        );
        ...
        _refresh : function(){
            ...
            var refreshMarkup = $.fn.cupcakewidget.refreshMarkup(config.iconRefresh),
                refreshSpinMarkup = $.fn.cupcakewidget.refreshMarkup(config.iconRefresh +' '+ config.iconSpin);
        ...
        _toggle : function() {
            ...
            var toggleOpenMarkup = $.fn.cupcakewidget.toggleOpenMarkup(config),
                toggleCloseMarkup = $.fn.cupcakewidget.toggleCloseMarkup(config);
        ...
        _header_footer : function(type) {
            ...
            elem.on('click', function (e){
                ...
                elem.trigger("beforeClick.cupcake");
                ...
                elem.trigger("afterClick.cupcake");
            ...
            _headerFooterOnResize = function () {
                ...
                elem.trigger("beforeResize.cupcake");

                element.removeAttr( "style" );

                elem.trigger("afterResize.cupcake");
            };
        ...
        _menu : function() {
            ...
            if ((!isMobile.any) && config.navHover){
                ...
                rootNode.on('mouseenter',function(){
                    ...
                    elem.trigger("beforeHover.cupcake");
                    ...
                    elem.trigger("afterHover.cupcake");
            ...
            if(config.isNavHidden){
                ...
                elem.trigger("beforeLoad.cupcake");
                ...
                elem.trigger("afterLoad.cupcake");
            }
        ...
        _sanitizeData: function(data){
            ...
            for (var p in data) {
                // allow props to be accessed sans 'cupcake' prefix and log the overrides
                if (data.hasOwnProperty(p) && /^cupcake[A-Z]+/.test(p) ) {
                    val = data[p];
                    shortName = p.match(/^cupcake(.*)/)[1].replace(/^[A-Z]/, this._lowerCase);
    ...
    $.fn.cupcakewidget = function( options ) {

        return this.each(function() {
            if (!$.data(this, 'cupcakeWidget')) {
                $.data(this, 'cupcakeWidget', new cupcakeWidget( this, options ));
            }
        });
    ...
    $.fn.cupcakewidget.defaults = cupcakeWidget.prototype.defaults;
    ...
    //--------------------------------------
    $.fn.cupcakewidget.expandMarkup = function(config) {
        return '<i class="'+ config.iconExpand +'"></i>';
    };

    // Fullscreen contract markup
    //--------------------------------------
    $.fn.cupcakewidget.contractMarkup = function(config) {
        return '<i class="'+ config.iconContract +'"></i>';
    };

    // Delete markup
    //--------------------------------------
    $.fn.cupcakewidget.deleteMarkup = function(config) {
        return '<i class="'+ config.iconDelete +'"></i>';
    };

    // Refresh markup
    //--------------------------------------
    $.fn.cupcakewidget.refreshMarkup = function(icon) {
        return '<i class="'+ icon +'"></i>';
    };

    // Toggle open
    //--------------------------------------
    $.fn.cupcakewidget.toggleOpenMarkup = function(config) {
        return '<i class="'+ config.iconToggleOpen +'"></i>';
    };

    // Toggle close
    //--------------------------------------
    $.fn.cupcakewidget.toggleCloseMarkup = function(config) {
    ...
    //--------------------------------------
    // Version
    $.fn.cupcakewidget.version = function() { return 'Cupcake Widget: ' + version; };

    // Logger
    $.fn.cupcakewidget.log = function log() {
        if (window.console && console.log)
            console.log('[cupcake] ' + Array.prototype.join.call(arguments, ' ') );
    };

    // Automatically find and run ason widgets
    $(document).ready(function() {
        $( $.fn.cupcakewidget.defaults.autoSelector ).cupcakewidget();
    });
