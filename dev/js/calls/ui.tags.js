...
function runTagEditor(tagEditor, type){
    ...
    switch(type){
        ...
        case 'skin':
            $(tagEditor).tagEditor({ clickDelete: true, initialTags: ['custom style', 'custom tags', 'delete on right click', 'no delete icon', 'hello', 'world', 'and', 'Cupcake', 'is', 'awesome', ':)'], placeholder: 'Enter tags ...' });
        break;
    }
}
