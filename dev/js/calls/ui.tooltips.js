...
function runTooltipster(tip, type){
    ...
    switch(type){
        ...
        case 'html':
            $(tip).tooltipster({
                content: $('<img style="float:left; padding-right:10px;" src="img/#design.png" width="90" height="80" /><p style="text-align:left;"><h4 style="margin-bottom:5px;">#Design.net</h4> We love to make cool stuff for the web.</p>'),
